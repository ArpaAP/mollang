...
**최신 구현체는 현재 [C++](./Mollang_C++) 하나가 존재하며 다른 언어(Python, JS, ...)구현은 개발 예정입니다! 언제든지 PR은 환영드립니다!**
...
각 코드는 줄바꿈(`\n`) 또는 띄어쓰기로 구분합니다. 그렇지 않고 한 줄에 여러 코드를 입력하면 컴파일 오류가 발생합니다. (단, `은?행 털!자`와 같은 일부 구문 제외)   
...
| 구현 언어                    | 구현 버전 |  추가 날짜  |
|-----------------------------|-----------|------------|
| [**C++**](./Mollang_C++)    | 1.1       | 2022.02.09 |
| [**Node.JS**](./Mollang_JS) | 1.0       | 2022.02.12 |
| Python3 (예정)              | -         | -          |

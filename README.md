...
**[몰랭 웹 인터프리터](https://molu.vercel.app) 사이트에서 1.1버전의 몰랭을 실시간, 대화형으로 실행해볼 수 있습니다!** 웹 인터프리터의 소스 코드 및 설명은 [여기](https://github.com/ArpaAP/molu-web)에 있습니다.
...
**최신 구현체는 현재 [C++](./Mollang_C++)가 존재하며 다른 언어(Python, ...)구현은 개발 예정입니다! 언제든지 PR은 환영드립니다!**
